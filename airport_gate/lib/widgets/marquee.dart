...
/// fork of https://github.com/MarcelGarus/marquee
...
class Marquee extends StatefulWidget {
  ...
  /// ## Sample code
  ///
  /// This [MarqueeWidget] starts scrolling one second after being displayed.
  ///
  /// ```dart
  /// Marquee(
  ...
  /// The fraction of the [MarqueeWidget] that will be faded on the left or top.
  ...
  /// The fraction of the [MarqueeWidget] that will be faded on the right or down.
  /// By default, there won't be any fading.
  ///
  /// ## Sample code
  ///
  ...
  /// This function will be called if [numberOfRounds] is set and the [MarqueeWidget]
...
class _MarqueeWidgetState extends State<Marquee> with SingleTickerProviderStateMixin {
